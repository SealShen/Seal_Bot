...
maintained by: leond（與 Claude 在 MyClaw session 內討論後更新）
...
- **python vs python3 指令比例懸殊**（21:144）
  原因：兩者指向同一個 `/c/Users/leond/AppData/Local/Microsoft/WindowsApps/python` → Python 3.14.3 binary，純粹是下指令風格差異，無環境不一致問題。
  判斷日期：2026-04-19
...
- **Netivism Redmine 工作流閉環**
  位置：`C:/Users/leond/.claude/projects/c--Users-leond-Netivism-Claude/memory/reference_redmine_workflow.md`
  入索引日期：2026-04-19

- **雙專案並行節奏（MyClaw 即時 / Netivism 批次）**
  位置：`C:/Users/leond/.claude/projects/c--Users-leond-MyClaw/memory/user_role.md`
  入索引日期：2026-04-19

- **Bot 改完需提醒使用者手動重啟**
  位置：`C:/Users/leond/.claude/projects/c--Users-leond-MyClaw/memory/feedback_bot_restart.md`

- **Claude Code CLI 模型切換需顯式 model ID**
  位置：`C:/Users/leond/.claude/projects/c--Users-leond-MyClaw/memory/feedback_explicit_model_ids.md`
